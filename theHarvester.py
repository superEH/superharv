...
print "                   B,                             sG        "
print "                                                            "
print "                      sBB@@@B@9,     ,G@B@B@BMr             " 
print "                     GB@B@Bi  s@BX   9B@s  rB@B@B9          "  
print "                  ,9@B@B@B@B@GBB@BX G@@BBM@B@B@B@B@9        "   
print "                 ,B@B@B@B@GXS2si:rr rriis2S9G@B@B@B@B,      "    
print "                ,B@@@2:                         i5@B@B,     "     
print "                B@r             :@B@B@              s@M     "      
print "               ,:                ,@BB                 i,    "          
...
def usage():
    ...
    print """-b: data source: baidu, bing, bingapi, dogpile,google, googleCSE, googleplus,
	google-profiles,linkedin, pgp, twitter, vhost,  yahoo, all\n"""
   # print "       -s: Start in result number X (default: 0)"
    ...
    #print "\nExamples:"
    print "     ->   " + comm + " -d ejample.com -l 500 -b google -h myresults.html"
    print "     ->   " + comm + " -d ejample.com -b pgp"
    print "     ->   " + comm + " -d ejample -l 200 -b linkedin"
